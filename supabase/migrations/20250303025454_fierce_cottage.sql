/*
  # Add campaign_coordinates column to campaigns table

  1. Changes
     - Add campaign_coordinates JSONB column to campaigns table
     - This column will store the latitude and longitude coordinates for campaign locations
*/
